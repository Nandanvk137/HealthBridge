// =============================================================================
// CareSync — App Constants
// Central configuration for all app-wide constants, routes, and settings.
// =============================================================================
...
class AppConstants {
  ...
  static const String appTagline = 'Your health, perfectly in sync';
  static const String appVersion = '2.0.0';
  static const String appDescription =
      'A modern healthcare platform connecting Doctors, Pharmacists, and Patients.';
  ...
  static const String bmiCalculatorRoute = '/bmi-calculator';
  ...
  // Database
  // ---------------------------------------------------------------------------
  static const String databaseName = 'caresync.db';
  ...
  // ---------------------------------------------------------------------------
  // Health Tips (used in HealthTipsSection widget)
  // ---------------------------------------------------------------------------
  static const List<Map<String, String>> healthTips = [
    {
      'title': 'Stay Hydrated',
      'body': 'Drink at least 8 glasses of water daily to keep your body functioning optimally.',
      'icon': '💧',
    },
    {
      'title': 'Move Every Hour',
      'body': 'Take a short walk or stretch every hour to reduce the risks of a sedentary lifestyle.',
      'icon': '🚶',
    },
    {
      'title': 'Sleep Well',
      'body': 'Adults need 7–9 hours of quality sleep each night for optimal physical and mental health.',
      'icon': '🌙',
    },
    {
      'title': 'Eat Balanced',
      'body': 'Include fruits, vegetables, whole grains, and lean protein in every meal.',
      'icon': '🥗',
    },
    {
      'title': 'Manage Stress',
      'body': 'Practice mindfulness or deep breathing exercises to reduce daily stress levels.',
      'icon': '🧘',
    },
    {
      'title': 'Regular Check-ups',
      'body': 'Schedule routine health check-ups at least once a year to catch issues early.',
      'icon': '🏥',
    },
  ];
}
